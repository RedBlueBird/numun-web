  ...
  return (
    <div className={`${tokens.borderRadius["2xl"]} overflow-hidden`}>
      ...
      <div className="px-6 pt-5">
        <h3 className={`text-3xl font-bold text-numun-green-darkest text-center ${fonts.itcBenguiat}`}>
          {day}
        </h3>
      </div>
        ...
        >
          {entries.map((entry, index) => (
            <React.Fragment key={index}>
              ...
              <div
                className={`bg-numun-green text-white text-xs font-semibold px-3 py-2.5 flex items-center ${fonts.cerebri}`}
              >
                {entry.time ?? ""}
              </div>
              ...
              <div
                className={`bg-numun-beige text-numun-green-darkest text-xs font-medium px-3 py-2.5 flex items-center ${fonts.cerebri} ${!entry.location ? "col-span-2" : ""}`}
              >
                {entry.event}
              </div>
              ...
              {entry.location && (
                <div
                  className={`bg-numun-beige text-numun-green-darkest text-xs font-semibold px-3 py-2.5 flex items-center ${fonts.cerebri}`}
                >
                  {entry.location}
                </div>
              )}
